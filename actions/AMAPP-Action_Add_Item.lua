-- @description AMAPP: Add Items to Cluster
-- @author Mount West Music AB
-- @version 0.5.0
-- @about Adds currently selected REAPER items to the selected cluster
...
reaper.SetExtState("AMAPP", "action_request", "add_item", false)
