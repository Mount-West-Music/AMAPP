-- @description AMAPP: Toggle Arm Cluster
-- @author Mount West Music AB
-- @version 0.5.0
-- @about Toggles the arm/record state on the selected cluster
...
reaper.SetExtState("AMAPP", "action_request", "toggle_arm", false)
