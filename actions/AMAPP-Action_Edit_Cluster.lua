-- @description AMAPP: Edit Selected Cluster
-- @author Mount West Music AB
-- @version 0.5.0
-- @about Opens the edit dialog for the currently selected cluster
...
reaper.SetExtState("AMAPP", "action_request", "edit_cluster", false)
