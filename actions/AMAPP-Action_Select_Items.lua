-- @description AMAPP: Select Items in Cluster
-- @author Mount West Music AB
-- @version 0.5.0
-- @about Selects all REAPER items belonging to the selected cluster
...
reaper.SetExtState("AMAPP", "action_request", "select_items", false)
