-- @description AMAPP: Toggle Timeline Overlay
-- @author Mount West Music AB
-- @version 0.5.0
-- @about Toggles the cluster timeline overlay visibility
...
reaper.SetExtState("AMAPP", "action_request", "toggle_overlay", false)
