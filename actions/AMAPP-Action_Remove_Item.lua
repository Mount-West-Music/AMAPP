-- @description AMAPP: Remove Items from Cluster
-- @author Mount West Music AB
-- @version 0.5.0
-- @about Removes currently selected REAPER items from their cluster
...
reaper.SetExtState("AMAPP", "action_request", "remove_item", false)
