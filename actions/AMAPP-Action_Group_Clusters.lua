-- @description AMAPP: Group Selected Clusters
-- @author Mount West Music AB
-- @version 0.5.0
-- @about Opens the create group dialog for selected clusters
...
reaper.SetExtState("AMAPP", "action_request", "group_clusters", false)
